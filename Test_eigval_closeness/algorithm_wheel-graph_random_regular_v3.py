'''
It simulates the optimized structure: but two graph components (wheel and random regular) connected via an edge.
'''
...
path = 'wheel_RR_graph_v3.txt'
s2 = 500
r = 6
#epsilon = 0.0000001 #0.02
#epsilon = 0.00002
#s1 = int(np.ceil(np.power(r+epsilon-1,2)))
s1 = 24
...
print 's1: %d ipr1: %0.4f ipr2: %0.4f ipr3: %0.4f lam1: %0.16f lam2: %0.4f lam3: %0.4f\n'%(s1,ipr1,ipr2,ipr3,lam1,lam2,lam3)                                                                                                        
...
print 's2: %d ipr1: %0.4f ipr2: %0.4f ipr3: %0.4f lam1: %0.16f lam2: %0.4f lam3: %0.4f\n'%(s2,ipr1,ipr2,ipr3,lam1,lam2,lam3)                                                                                                        
